...
const BASE = `
  ...
  CREATE TABLE findings (id INTEGER PRIMARY KEY, asset_id INTEGER, title TEXT, kind TEXT, severity TEXT, body TEXT, refs TEXT, fix_status TEXT, in_report INTEGER, author TEXT, cvss TEXT, needs_improvement INTEGER, review_note TEXT, created_at TEXT);
