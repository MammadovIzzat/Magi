...
sudo pacman -U packaging/magi-0.9.24-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.9.24_amd64.deb
```
...
chmod +x dist/installers/Magi-0.9.24.AppImage
./dist/installers/Magi-0.9.24.AppImage
```
...
# dist/installers/Magi-0.9.24-mac.zip         Intel
# dist/installers/Magi-0.9.24-arm64-mac.zip   Apple Silicon
```
