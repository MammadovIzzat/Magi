...
sudo pacman -U packaging/magi-0.8.5-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.8.5_amd64.deb
```
...
chmod +x dist/installers/Magi-0.8.5.AppImage
./dist/installers/Magi-0.8.5.AppImage
```
...
# dist/installers/Magi-0.8.5-mac.zip         Intel
# dist/installers/Magi-0.8.5-arm64-mac.zip   Apple Silicon
```
