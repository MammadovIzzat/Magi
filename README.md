...
sudo pacman -U packaging/magi-10.2.0-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_10.2.0_amd64.deb
```
...
chmod +x dist/installers/Magi-10.2.0.AppImage
./dist/installers/Magi-10.2.0.AppImage
```
...
# dist/installers/Magi-10.2.0-mac.zip         Intel
# dist/installers/Magi-10.2.0-arm64-mac.zip   Apple Silicon
```
