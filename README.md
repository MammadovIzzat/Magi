...
sudo pacman -U packaging/magi-0.5.6-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.5.6_amd64.deb
```
...
chmod +x dist/installers/Magi-0.5.6.AppImage
./dist/installers/Magi-0.5.6.AppImage
```
...
# dist/installers/Magi-0.5.6-mac.zip         Intel
# dist/installers/Magi-0.5.6-arm64-mac.zip   Apple Silicon
```
