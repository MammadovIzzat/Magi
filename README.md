...
sudo pacman -U packaging/magi-0.9.26-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.9.26_amd64.deb
```
...
chmod +x dist/installers/Magi-0.9.26.AppImage
./dist/installers/Magi-0.9.26.AppImage
```
...
# dist/installers/Magi-0.9.26-mac.zip         Intel
# dist/installers/Magi-0.9.26-arm64-mac.zip   Apple Silicon
```
