...
sudo pacman -U packaging/magi-0.9.25-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.9.25_amd64.deb
```
...
chmod +x dist/installers/Magi-0.9.25.AppImage
./dist/installers/Magi-0.9.25.AppImage
```
...
# dist/installers/Magi-0.9.25-mac.zip         Intel
# dist/installers/Magi-0.9.25-arm64-mac.zip   Apple Silicon
```
