...
sudo pacman -U packaging/magi-0.9.17-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.9.17_amd64.deb
```
...
chmod +x dist/installers/Magi-0.9.17.AppImage
./dist/installers/Magi-0.9.17.AppImage
```
...
# dist/installers/Magi-0.9.17-mac.zip         Intel
# dist/installers/Magi-0.9.17-arm64-mac.zip   Apple Silicon
```
