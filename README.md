...
sudo pacman -U packaging/magi-0.6.3-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.6.3_amd64.deb
```
...
chmod +x dist/installers/Magi-0.6.3.AppImage
./dist/installers/Magi-0.6.3.AppImage
```
...
# dist/installers/Magi-0.6.3-mac.zip         Intel
# dist/installers/Magi-0.6.3-arm64-mac.zip   Apple Silicon
```
