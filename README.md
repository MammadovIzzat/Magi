...
sudo pacman -U packaging/magi-0.9.3-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_0.9.3_amd64.deb
```
...
chmod +x dist/installers/Magi-0.9.3.AppImage
./dist/installers/Magi-0.9.3.AppImage
```
...
# dist/installers/Magi-0.9.3-mac.zip         Intel
# dist/installers/Magi-0.9.3-arm64-mac.zip   Apple Silicon
```
