...
sudo pacman -U packaging/magi-10.2.1-1-any.pkg.tar.zst
```
...
sudo apt install ./dist/installers/magi_10.2.1_amd64.deb
```
...
chmod +x dist/installers/Magi-10.2.1.AppImage
./dist/installers/Magi-10.2.1.AppImage
```
...
# dist/installers/Magi-10.2.1-mac.zip         Intel
# dist/installers/Magi-10.2.1-arm64-mac.zip   Apple Silicon
```
